    ...
    <div style={{ height: "100vh", width: "100vw", position: "relative", display: "flex", flexDirection: "row" }}>
      ...
      <div style={{ flex: 1, height: "100%", position: "relative" }}>
        ...
        <MapContainer center={centerPos} zoom={11} style={{ height: "100%", width: "100%" }}>
          ...
          {showTraffic ? (
            <TileLayer attribution='Google Maps' url="https://mt0.google.com/vt/lyrs=m,traffic&hl=en&x={x}&y={y}&z={z}" maxZoom={20} />
          ) : (
          ...
          {startPoint && endPoint && <RoutingControl start={startPoint} end={endPoint} onRoutesFound={setRoutes} airData={airData} />}
